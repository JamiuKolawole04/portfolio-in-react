...
export const HeroSection = () => {
  ...
  useEffect(() => {
    init(textRef.current, {
      backDelay: 1500,
      showCursor: true,
      strings: ["Jay", "a Web Developer"],
    });
  }, []);

  const description =
    "A web developer with years of hands-on experience using a broad range of frontend and backend technologies to develop and maintain advanced, responsive, efficient, and reliable web applications.";
